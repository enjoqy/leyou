package org.junhi.search.service;
...
import org.junhi.search.client.BrandClient;
import org.junhi.search.client.CategoryClient;
import org.junhi.search.client.GoodsClient;
import org.junhi.search.client.SpecificationClient;
...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        skus.forEach(sku -> {
            ...
            //获取sku中图片，数据库的图片可能是多张，多张是以","分隔，所有也用逗号来切割返回图片数组，获取第一张图片
